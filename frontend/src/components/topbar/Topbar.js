      ...
      {user? (
        <>
          <div className="topleft">
            ...
            <Link to="https://www.linkedin.com/in/akhilesh-bonde/"target="_blank" className="link" style={{marginTop:"4px"}}><FaLinkedin className="topIcons" /></Link>
            <Link to="https://www.instagram.com/akhileshh.b__/" target="_blank" className="link" style={{marginTop:"4px"}}><FaInstagramSquare className="topIcons" /></Link>
        ...
        <div className="center">blogAGE</div>
      )}
